  ...
  return (
    <>
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        className="fixed bottom-6 left-6 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-sky-600 to-teal-500 text-white shadow-lg"
      >
        <MessageCircle className="h-5 w-5" />
      </button>
      {open && (
        <div className="fixed bottom-24 left-6 z-40 w-80 overflow-hidden rounded-xl border bg-background shadow-xl">
