          ...
          <CardContent className="p-5 space-y-3">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setData({
                    ...data,
                    basics: { ...data.basics, title: e.target.value },
                  })
                }
              />
              <Input
              ...
              <Input
                ...
                onChange={(e) =>
                  setData({
                    ...data,
                    basics: { ...data.basics, phone: e.target.value },
                  })
                }
              />
              <Input
                ...
                onChange={(e) =>
                  setData({
                    ...data,
                    basics: { ...data.basics, location: e.target.value },
                  })
                }
              />
            </div>
            <Textarea
              ...
              onChange={(e) =>
                setData({
                  ...data,
                  basics: { ...data.basics, summary: e.target.value },
                })
              }
            />
          </CardContent>
              ...
              {data.skills.map((s, i) => (
                <Badge
                  ...
                  onClick={() =>
                    setData({
                      ...data,
                      skills: data.skills.filter((x, idx) => idx !== i),
                    })
                  }
          ...
          <CardContent className="p-5 space-y-4">
            ...
            {data.education.map((ed, idx) => (
              <div key={ed.id} className="rounded-md border p-3 grid gap-2">
                ...
                <Textarea
                  placeholder="Highlights (awards, GPA, coursework)"
                  value={ed.details}
                  onChange={(e) => {
                    const v = e.target.value;
                    setData((d) => ({
            ...
            {data.skills.length > 0 && (
              <div>
                ...
                <div className="mt-1 flex flex-wrap gap-2">
                  {data.skills.map((s, i) => (
                    <Badge key={`${s}_${i}`} variant="secondary">
                      {s}
                    </Badge>
                  ))}
                </div>
                      ...
                      {p.technologies.length > 0 && (
                        <div className="mt-1 flex flex-wrap gap-2">
                          {p.technologies.map((t, i) => (
                            <Badge key={`${t}_${i}`} variant="secondary">
                              {t}
                            </Badge>
                          ))}
                        </div>
